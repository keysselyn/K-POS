...
class VenderController extends Controller
{
    ...
    public function terminarVenta(Request $request)
    {
        ...
        foreach ($productos as $producto) {
            ...
            $productoVendido->fill([
                ...
                "itbis" => ((($producto->precio_venta * $producto->porcentaje) /100) * $producto->cantidad),
                "valor" => ((($producto->precio_venta * $producto->porcentaje /100) + $producto->precio_venta)*$producto->cantidad),
    ...
    public function agregarProductoVenta(Request $request)
    {
        ...
        ->join('impuestos', 'impuestos.id', '=', 'itbis')->select('Productos.id as id', 'codigo_barras','Productos.descripcion as descripcion','precio_venta', 'existencia','impuestos.porcentaje as porcentaje')->first();
        if (!$producto) {
            return redirect()
                ->route("vender.index")
    ...
    public function index()
    {
        ...
        foreach ($this->obtenerProductos() as $producto) {
            ...
            $itbis += ($producto->cantidad * $producto->precio_venta)*$producto->porcentaje/100;
