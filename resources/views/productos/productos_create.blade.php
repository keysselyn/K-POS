...
@section('content_header')
    <h1>Nuevo producto <i class="fas fa-plus"></i></h1>
    <hr />
@stop
        ...
        <div class="card card-success">
            ...
            <div class="row">
                <div class="col-3 form-group">
                    ...
                    <input required autocomplete="off" name="codigo_barras" class="form-control form-control-border border-width-2"
                           type="text" placeholder="Código de barras">
                </div>
                <div class="col-6 form-group">
                    <label class="label">Descripción</label>
                    <input required autocomplete="off" name="descripcion" class="form-control form-control-border border-width-2"
            ...
            <div class="row">
                <div class="col-4 form-group">
                    ...
                    <input required autocomplete="off" name="precio_compra" class="form-control form-control-border border-width-2"
                           type="decimal(9,2)" placeholder="Precio de compra">
                </div>
                <div class="col-4 form-group">
                    <label class="label">Precio de venta</label>
                    <input required autocomplete="off" name="precio_venta" class="form-control form-control-border border-width-2"
            ...
            <div class="row">
                <div class="col form-group">
                    ...
                    <input required autocomplete="off" name="existencia" class="form-control form-control-border border-width-2"
                           type="decimal(9,2)" placeholder="Existencia">
                </div>

                <div class="col form-group">
                    <label class="label">Existencia Minima</label>
                    <input required autocomplete="off" name="existencia_minima" class="form-control form-control-border border-width-2"
