            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-3 form-group">
                        ...
                        <input required value="{{$cliente->rnc}}" autocomplete="off" name="rnc"
                           class="form-control form-control-border border-width-2"
                           type="text" placeholder="Rnc">
                    </div>
                    <div class="col form-group">
                        <label class="label">Nombre</label>
                        <input required value="{{$cliente->nombre}}" autocomplete="off" name="nombre" class="form-control form-control-border border-width-2"
                ...
                <div class="row">
                    <div class="col form-group">
                        ...
                        <input required value="{{$cliente->municipio}}" autocomplete="off" name="municipio"
                           class="form-control form-control-border border-width-2"
                           type="text" placeholder="Municipio">
                    </div>
                    <div class="col  form-control-group">
                        <label class="label">Provincia</label>
                        <input required value="{{$cliente->provincia}}" autocomplete="off" name="provincia"
                           class="form-control form-control-border border-width-2"
